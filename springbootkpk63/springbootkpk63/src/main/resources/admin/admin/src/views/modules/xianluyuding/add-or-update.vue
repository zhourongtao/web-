<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出行时间" prop="chuxingshijian">
          <el-input v-model="ruleForm.chuxingshijian" 
              placeholder="出行时间" clearable  :readonly="ro.chuxingshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出行时间" prop="chuxingshijian">
              <el-input v-model="ruleForm.chuxingshijian" 
