<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="线路费用" prop="xianlufeiyong">
          <el-input v-model="ruleForm.xianlufeiyong" 
              placeholder="线路费用" clearable  :readonly="ro.xianlufeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="线路费用" prop="xianlufeiyong">
              <el-input v-model="ruleForm.xianlufeiyong" 
                placeholder="线路费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="费用包含" prop="feiyongbaohan">
          <el-input v-model="ruleForm.feiyongbaohan" 
              placeholder="费用包含" clearable  :readonly="ro.feiyongbaohan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="费用包含" prop="feiyongbaohan">
              <el-input v-model="ruleForm.feiyongbaohan" 
                placeholder="费用包含" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xingchengluxian = this.ruleForm.xingchengluxian.replace(reg,'../../../springbootkpk63/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
