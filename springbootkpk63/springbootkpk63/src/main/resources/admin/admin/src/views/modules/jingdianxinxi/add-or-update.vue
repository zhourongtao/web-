<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="门票类型" prop="menpiaoleixing">
          <el-select v-model="ruleForm.menpiaoleixing" placeholder="请选择门票类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="门票类型" prop="menpiaoleixing">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询热线" prop="zixunrexian">
          <el-input v-model="ruleForm.zixunrexian" 
              placeholder="咨询热线" clearable  :readonly="ro.zixunrexian"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.menpiaoleixingOptions = "普票,联票,通票".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../springbootkpk63/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
